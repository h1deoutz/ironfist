...
<script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
  ...
  <body class="body" onload="solicitacao()">
<p>
            <?php 
          ...
          <div class="col" style="color: #ffffff; font-weight: 500; letter-spacing: px; font-size: 15px; top: 5px; display: flex; justify-content: space-between;" >
           ...
           <div style="padding-right:20px;">
            ...
            <div class="wrapper">
              ...
              <h2>Entrar</h2>
              <form class="form-signing"method= "POST" action="valida.php">
                <div class="input-box">
              ...
              <div class="input-box">
                ...
                <input type="password" class="input-senha" name="senha" required>
                <label>Senha</label>
              </div>
      ...
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" style="margin-top: 10px; box-shadow: 10px 10px 10px 10px rgb(255, 255, 255);"> 
        <div class="carousel-inner">
          <div class="carousel-item active">
           <picture> <source media="(max-width: 800px )" srcset="img-svg/5.png" type=""><img src="img-svg/5.png" class="d-block w-100" alt="..." style=" height: 700px ;"></picture>
          </div>
          <div class="carousel-item active">
            <picture> <source media="(max-width: 800px )" srcset="img-svg/logo.png" type=""><img src="img-svg/7.png" class="d-block w-100" alt="..." style=" height: 700px ;" ></picture>
           </div>
           <div class="carousel-item active">
            <picture> <source media="(max-width: 800px )" srcset="img-svg/logo.png" type=""><img src="img-svg/9.png" class="d-block w-100" alt="..." style=" height: 700px ;"></picture>
           </div>
        </div>
        ...
        <div class="checkout-page">
          <div class="step1">
            ...
            <form action="">
              ...
              <button class="confirmar">Ir Para o Pagamento</button>
             ...
             <div class="step2-payment-method">
              ...
              <div class="credit-card">
                ...
                <div class="credit-card-header">
                  ...
                  <div class="alterar" id="alterar-card"><p>Alterar forma de pagamento</p></div>
                </div>
              ...
              <div class="valiade-cvv">
                ...
                <div class="pix">
                  ...
                  <div class="pix-header">
                    <div class="pix-title">
                      <span><ion-icon name="qr-code-outline"></ion-icon></span> <h6>
                        Pix à vista
                      </h6>
                    </div>
                    <div class="alterar" id="alterar-pix"><p>Alterar forma de pagamento</p></div>
                  </div>

                  <p>Realize o pagamento pelo seu banco preferido escaneando a imagem ou colando o código do QR Code</p>

                  <div class="qr">
                    <img src="img-svg/qrcode-pix.png" alt="">
                  </div>
                  ...
                  <div class="boleto">
                    ...
                    <div class="boleto-header">
                      <div class="boleto-title">
                        <span><i class="fa-solid fa-barcode"></i></span> <h6>
                          Boleto à vista
                        </h6>
                      </div>
                      <div class="alterar" id="alterar-boleto"><p>Alterar forma de pagamento</p></div>
                    </div>

                        <div class="imprimir">
                          <span><i class="fa-solid fa-barcode"></i></span>
                          <h6>Imprimir Boleto</h6>
                        </div>                
                </div>
