    ...
    <div class="header" style=" z-index: 2; position: fixed; width: 100%; background-color: #2b0086; height: 48px;" >
      ...
      <nav class="navbar navbar-expand-lg bg-body-primary">
        ...
        <div class="product-page">
            ...
            <img src="../img-svg/whey_chocolate.jpeg" class="responsive" alt="" id="bannerImage">

            <div class="product-info">
              <h2>Whey Protein Concentrado IronFist 1Kg</h2>
              <button onclick="changeImage('../img-svg/whey_chocolate.jpeg')">Chocolate</button>
              <button  onclick="changeImage('../img-svg/whey_morango.jpeg')">Morango</button>
              <button  onclick="changeImage('../img-svg/whey_baunilha.jpeg')">Baulinha</button> <br>
              <h2 style="text-decoration: underline;">R$109,99</h2>
              <div class="add"><button onclick='addtocart("+(i++)+")'>Adicionar ao carrinho</button></div>
              <div class="about">
                <p>O maior aliado para quem busca hipertrofia e ganho de massa é o Whey Protein da Iron Fist! Alta concentração de proteínas e aminoácidos fundamentais para o alto rendimento, entregando a maior qualidade possível.</p>
              </div>
            </div>
        ...
        <div class="description">
          ...
          <p>Lorem ipsum, dolor sit amet csaasdonsectetur adipisicing elit. Hic sequi accusamus earum perspiciatis illum iure nobis facilis deleniti velit nostrum nam, quia nemo itaque elhojjlçjlsse ut quidem minus aliquam minima.</p>
          <h2>Ingredientes</h2>
          ...
          <h2>Avertências</h2>
          <p>Ao considerar o whey protein, esteja atento a possíveis alergias a laticínios, evite excesso que possa causar desconforto, consulte um profissional se tiver condições médicas, e assegure-se de seguir as orientações diárias de proteína para evitar sobrecarga nos rins.</p>
        </div>
